...
function AdminListingTypeSelection() {
  ...
  return (
    <div className="min-h-screen bg-background py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <Link href="/admin/listings" className="inline-flex items-center text-primary hover:text-primary/90 mb-6">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          ...
          >
            ...
            <CardContent>
              <div className="mb-3 p-2 bg-green-50 border border-green-200 rounded text-center">
                <p className="text-sm font-semibold text-green-800">15% Commission | Booking Enabled</p>
              </div>
          ...
          >
            ...
            <CardContent>
              <div className="mb-3 p-2 bg-green-50 border border-green-200 rounded text-center">
                <p className="text-sm font-semibold text-green-800">12% Commission | Booking Enabled</p>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-center">
                  <span className="mr-2">✓</span>
          ...
          >
            ...
            <CardContent>
              <div className="mb-3 p-2 bg-blue-50 border border-blue-200 rounded text-center">
                <p className="text-sm font-semibold text-blue-800">Inquiry Only | No Commission</p>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-center">
                  <span className="mr-2">✓</span>
...
export default function AdminNewListingPage() {
  return <AdminListingTypeSelection />;
}
