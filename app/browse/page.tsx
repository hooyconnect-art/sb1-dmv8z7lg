...
import { MapPin, Star, Bed, Bath, Users, Wifi, Car, Calendar, Building2 } from 'lucide-react';
...
interface Listing {
  id: string;
  listing_type: 'hotel' | 'fully_furnished' | 'guesthouse' | 'rental';
...
export default function BrowsePage() {
  ...
  const renderPropertyCard = (listing: Listing) => {
    ...
    const displayType = listing.listing_type === 'hotel'
      ...
      ? 'Fully Furnished'
      : listing.listing_type === 'guesthouse'
      ? 'Guesthouse'
      : 'Rental';
          ...
          <div className="text-center py-20 bg-white rounded-2xl shadow-sm border">
            <div className="max-w-md mx-auto">
              ...
              <p className="text-gray-600 mb-6">
                We couldn't find any available properties at the moment. Check back soon!
              </p>
            </div>
          </div>
        )}
