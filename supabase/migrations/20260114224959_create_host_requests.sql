/*
  ...
  3. Important Notes
    - Users start as 'guest' role by default
    - Only admins can approve requests and change user roles
    - Each user can have multiple requests (if rejected, they can reapply)
*/
